...
describe('agentInsertionPreviewBuilder', () => {
  ...
  it('attaches preview metadata and solid edge styling to generated graph nodes', () => {
    ...
    expect(graph.edges.find((edge) => edge.target === previewNodeId)?.style).toMatchObject({

        ...
        <div className="min-w-0 flex-1">
          ...
          {data.editing ? (
            ...
            />
              ...
              {imageUrls.length > 0 && <div className="mindmap-heavy-content nodrag nopan relative mt-2 block w-full max-w-[240px]" onClick={(event) => event.stopPropagation()}>
...
const EditableNodeTable: React.FC<{ table: string[][]; onChange: (table: string[][]) => void }> = ({ table, onChange }) => {
  ...
  return <div ref={tableRef} className="mindmap-heavy-content group/table nodrag nopan relative mt-2 block w-max max-w-[630px] overflow-visible pb-1 pt-3" onClick={(event) => event.stopPropagation()}>

...
export const MindMapInlineEditor: React.FC<MindMapInlineEditorProps> = ({
  ...
  return (
    <textarea
      ...
      rows={1}
      aria-label="编辑节点文本"
      className="mindmap-inline-editor nodrag nopan block w-auto min-w-[36px] max-w-[626px] touch-manipulation resize-none overflow-hidden whitespace-pre-wrap border-0 bg-transparent p-0 text-left text-sm font-medium leading-[1.45] text-zinc-800 shadow-none outline-none [field-sizing:content] focus:border-0 focus:outline-none focus:ring-0 focus-visible:outline-none"
